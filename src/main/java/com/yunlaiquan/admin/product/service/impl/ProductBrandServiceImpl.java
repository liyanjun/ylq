...
import com.yunlaiquan.admin.product.entity.ProductBrandEntity;
import com.yunlaiquan.admin.product.service.ProductBrandService;
...
public class ProductBrandServiceImpl implements ProductBrandService {
	...
	public ProductBrandEntity queryObject(Long id){
		return productBrandDao.queryObject(id);
	}
